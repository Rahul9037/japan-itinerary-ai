...
export const routes: RouteOption[] = [
  ...
  },
  {
    ...
    why: "Matches ‘snow if possible’ better than city Japan if your leave is the first week of November.",
    watchOut: "Do not run this in late November instead of Fuji — you would miss Kyoto peak colour. For 16 October, use the separate October card, not this one.",
  },
  {
    id: "route-osaka",
    badge: "Max shopping",
  ...
  },
  {
    id: "route-oct16",
    badge: "16 Oct 2026",
    name: "October dates · Tokyo · Nikko · Kyoto",
    tagline: "Same family trip, different week: land Friday 16 Oct. Colour is at Lake Chuzenji, not Kyoto. No snow.",
    nights: "9 nights (16–25 Oct 2026)",
    corePerAdult: "₹1.15 lakh",
    snow: "Do not expect snow. Chuzenji mornings are cold. Fuji is not the point in mid-October.",
    shopping: "Saturday 17 Oct in Shinjuku/Shibuya. Extra wallet, same rule as November.",
    pace: "Lake Chuzenji is the colour day. Toshogu only if the lake is socked in. One cluster, then stop.",
    baby: "Carrier at Toshogu. Milder than a November lake stay. Hotel breakfast in Nikko.",
    when: "Leave BLR Thu 15 Oct night. Japan Fri 16 – Sun 25 Oct. Fly KIX.",
    stays: ["Asakusa 3N", "Nikko / Chuzenji 2N", "Kyoto 4N"],
    placeIds: ["tokyo", "nikko", "kyoto"],
    days: [
      { date: "16 Oct", title: "Land Narita → Asakusa. Senso-ji at dusk." },
      { date: "17 Oct", title: "Tokyo shopping day (own wallet)." },
      { date: "18 Oct", title: "Meiji / easy Tokyo. Pack for Nikko." },
      { date: "19 Oct", title: "Spacia to Nikko. Short walk only." },
      { date: "20 Oct", title: "Chuzenji + Kegon. Toshogu only if you skip the lake." },
      { date: "21 Oct", title: "Shinkansen to Kyoto. Rest." },
      { date: "22–24 Oct", title: "Kyoto slow: west, then east, then a buffer day." },
      { date: "25 Oct", title: "Haruka to KIX." },
    ],
    why: "16 October sits inside Nikko’s best foliage week (about 15–22 Oct). You still get Tokyo, shopping, two other cities, and a slow Kyoto — just without red maples or snow.",
    watchOut: "Do not use the Fuji-lake or late-November maple plan on these dates. Irohazaka is ugly on 17–18 Oct — go up on Monday 19 / Tuesday 20.",
  },
  {
    id: "route-kanazawa",
    badge: "Calmest",
